...
export default async function ServiceCityPage({ params }: PageProps) {
  ...
  return (
    <>
      ...
      {/* Unique SEO content (generated by pipeline) — positioned low, for crawlers.
          Human visitors see the marketing sections first; the dense, keyword-rich
          local copy sits near the bottom. Falls back to the static template below. */}
      {uniqueContent && (
        <SEOPageContent
